...
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%OUTPUT_PATH%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%OUTPUT_PATH2%"
pause
xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%LABYRINTH_PATH%"
xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%LABYRINTH_PATH2%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%LABYRINTH_PATH%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%LABYRINTH_PATH2%"

xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%HANGMAN_PATH%"
xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%HANGMAN_PATH2%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%HANGMAN_PATH%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%HANGMAN_PATH2%"

xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%TICTACTOE_PATH%"
xcopy /Y ".\%DEPENDENCIES_PATH%\%FREEGLUT%" ".\%TICTACTOE_PATH2%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%TICTACTOE_PATH%"
xcopy /I /Y /E ".\%DEPENDENCIES_PATH%\%PROLOG%" ".\%TICTACTOE_PATH2%"
