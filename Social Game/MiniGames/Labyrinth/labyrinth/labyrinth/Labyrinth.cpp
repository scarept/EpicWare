...
Labyrinth::~Labyrinth(){}
	...
	{
		/*  texturas  menu */
		mod.menu = load2D(".\/images\/labyrinth\/menu.png");
	...
	void desenhaMenu(GLenum mode){
		...
		if (mode == GL_SELECT)
			glLoadName(1);
		GLuint imagem = load2D(".\/images\/labyrinth\/bt10.png");
		...
		if (mode == GL_SELECT)
			glLoadName(2);
		GLuint imagem20 = load2D(".\/images\/labyrinth\/bt20.png");
		...
		if (mode == GL_SELECT)
			glLoadName(3);
		GLuint imagem30 = load2D(".\/images\/labyrinth\/bt30.png");
		...
		if (mode == GL_SELECT)
			glLoadName(4);
		GLuint imagemExit = load2D(".\/images\/labyrinth\/btExit.png");
	...
	void initGame(char * file){
		...
		/* carregar iamgens */
		mod.imagem = load2D(".\/images\/labyrinth\/teste.png");
		mod.textura_paredes = load2D(".\/images\/labyrinth\/parede.png");
		...
		for (i = 0; i < hits; i++) { /* for each hit */
			...
			*/
			...
			for (j = 0; j < names; j++) { /* for each name */
				if (*ptr == 1){
					initGame(".\/pl\/teste.txt");
					teste = 1;

				}
				else if (*ptr == 2){
					initGame(".\/pl\/teste2.txt");
					teste = 1;
				}
				else if (*ptr == 3){
					initGame(".\/pl\/teste3.txt");
					teste = 1;
				}
				else if (*ptr == 4){
					glutLeaveMainLoop();
